...
import { GetLollipopUserForFIMSPayload } from "./GetLollipopUserForFIMSPayload.js";

import { FIMSPlusUser } from "./FIMSPlusUser.js";
...
// Request type definition
export type GetLollipopUserForFIMST = r.IPostApiRequestType<
  {
    readonly Bearer: string;
    readonly body:
  ...
  never,
  | r.IResponseType<200, FIMSPlusUser, never>
  | r.IResponseType<400, ProblemJson, never>
  | r.IResponseType<401, undefined, never>
...
export const getLollipopUserForFIMSDefaultResponses = {
  200: FIMSPlusUser,
  400: ProblemJson,
  401: t.undefined,
  403: t.undefined,
...
export type GetLollipopUserForFIMSResponsesT<
  A0 = FIMSPlusUser,
  C0 = FIMSPlusUser,
  A1 = ProblemJson,
  C1 = ProblemJson,
...
export function getLollipopUserForFIMSDecoder<
  A0 = FIMSPlusUser,
  C0 = FIMSPlusUser,
  A1 = ProblemJson,
  C1 = ProblemJson,
...
>(
  overrideTypes:
    | Partial<
        GetLollipopUserForFIMSResponsesT<
          A0,
          C0,
          A1,
          C1,
...
> {
  ...
  const type = {
    ...(getLollipopUserForFIMSDefaultResponses as unknown as GetLollipopUserForFIMSResponsesT<
      A0,
      C0,
      A1,
      C1,
  ...
  const d429 = (
    type[429].name === "undefined"
      ...
      : r.ioResponseDecoder<
          ...
          never
        >(429, type[429])
  ) as r.ResponseDecoder<r.IResponseType<429, A5, never>>;
...
// Decodes the success response with the type defined in the specs
export const getLollipopUserForFIMSDefaultDecoder = () =>
  getLollipopUserForFIMSDecoder();
