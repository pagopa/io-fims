{
  "swagger": "2.0",
  "info": {
    "title": "OpenID Provider Admin",
    "description": "OpenID Provider Admin API",
    "version": "2.0.0"
  },
    ...
    "/clients": {
      ...
      "get": {
        ...
        "parameters": [
          ...
          {
            "$ref": "#/parameters/queryServiceId"
          }
        ],
        "responses": {
          "200": {
            "$ref": "#/responses/200ClientListResponse"
          },
          "401": {
            "$ref": "#/responses/401Unauthorized"
          },
